...
- 2/5 issues: 4/18
  ...
  **Plan of Pair 3**
  ...
  | 5/7  | Final check and Tag                | M 6 | M 7 |  √  |
...
Click to src code: [BoCApp](../src/CW3/src/BoCCategory.java) & [BoCAppTest](../src/CW3/src/BoCCategoryTest.java)
...
|Importance|Status|Test|Inputs|Expected Outcome|Test Outcome|Problem|Change|Reason|Time|Author|
|----------|------|----|------|----------------|------------|-------|------|------|----|------|
| !! | FAIL | addTransactionTest 1 | "tran1\n", "", "1.00\n", "", "1\n", "", "1" | name is set to tran1, value is set to 1.00, category is set to 0, shows "tran1(¥1.00) was added to Unknown" | name is set to tran1, value is set to 1.00, category is set to 0, shows "tran1(¥1.00) was added to Unknown" prompt message is wrong | 1. Category cant be correctly set up 2. prompt message is different 3. Confirmation message is different | / | 1. No category input is set up 2. The original message does not match new expected one 3. Confirmation message has not been created yet | 23:15 4/5 | Shiliang |
| !!! | FAIL | addTransactionTest 2 | "\n", "tran2\n", "2.00\n", "", "1\n", "" | name is set to tran2, with an alert message,  value is set to 2.00, category is set to 0, shows "tran2(¥2.00) was added to Unknown" | InvocationException | 1. It does not alert and ask for new input 2. alert an invocation exception | / | 1. no loop was created | 23:15 4/5 | Shiliang |
| !! | FAIL | addTransactionTest 3 | "tran3\n", "", "\n", "3.00\n", "1\n", "" | name is set to tran3,  value is set to 2.00, with an alert message, category is set to 0, shows "tran3(¥3.00) was added to Unknown" | InvocationException | 1. It does not alert the right message and loop 2. alert an invocation exception | / | 1. no loop was created 2. BigDecimal get a "" | 23:15 4/5 | Shiliang |
| !! | FAIL | addTransactionTest 4 | "tran4\n", "", "4.00\n", "", "\n", "" | name is set to tran4, value is set to 4.00, category is set to 0, shows "tran4(¥4.00) was added to Unknown" | Category is  set to "tran4". value is set to 4.00. category is  set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop 2. confirmation message is not right | / | the prompt and confirmation message are not reset yet | 23:15 4/5 | Shiliang |
| !! | FAIL | addTransactionTest 5 | "tran5\n", "", "5.00\n", "", "6\n", "1\n" (where 6 is not yet created) | name is set to tran5, value is set to 5.00, category is set to 0, with an alert message, shows "tran5(¥5.00) was added to Unknown" | Category is  set to "tran5". value is set to 5.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | / | no loop was created | 23:15 4/5 | Shiliang |
| !! | FAIL | addTransactionTest 6 | "tran6\n", "", "0.00\n", "6.00\n", "1\n" | name is set to tran6,  value is set to 6.00, with an alert message, category is set to 0, shows "tran6(¥6.00) was added to Unknown" | Category is  set to "tran6". value is set to 0.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | / | no loop was created | 23:15 4/5 | Shiliang |
| !! | FAIL | addTransactionTest 7 | "tran7\n", "", "-5.00\n", "7.00\n", "1\n" | name is set to tran7,  value is set to 7.00, with an alert message, category is set to 0, shows "tran7(¥7.00) was added to Unknown" | Category is  set to "tran7". value is set to -5.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | / | no loop was created | 23:15 4/5 | Shiliang |
| !! | FAIL | addTransactionTest 8 | "tran8\n", "", "8.00\n", "", "0\n", "1\n" | name is set to tran8, value is set to 8.00, category is set to 0, with an alert message, shows "tran8(¥8.00) was added to Unknown" | Category is  set to "tran8". value is set to 8.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | / | no loop was created | 23:15 4/5 | Shiliang |
| !! | FAIL | addTransactionTest 9 | "tran9\n", "", "9.00\n", "", "-1\n", "1\n" | name is set to tran9, value is set to 9.00, category is set to 0, with an alert message, shows "tran9(¥9.00) was added to Unknown" | Category is  set to "tran9". value is set to 9.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | / | no loop was created | 23:15 4/5 | Shiliang |
| !! | FAIL | addTransactionTest 10 | "tttttrrrrraaaaannnnn10101\n", "", "10.00\n", "", "1\n", "" | name is set to tran10, value is set to 10.00, category is set to 0, shows "tttttrrrrraaaaannnnn10101(¥10.00) was added to Unknown" | Category is  set to "tttttrrrrraaaaannnnn10101". value is set to10.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | / | the prompt and confirmation message are not reset yet. | 23:15 4/5 | Shiliang |
| !! | FAIL | addTransactionTest 11 | "tttttrrrrraaaaannnnn111111111111\n", "", "11.00\n", "", "1\n", "" | name is set to tran11, with an alert message,  value is set to 11.00, category is set to 0, shows "tttttrrrrraaaaannnnn111111(¥11.00) was added to Unknown" | Category is  set to "tttttrrrrraaaaannnnn111111111111". value is set to11.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. the length is not right | / | no truncate exception is catched | 23:15 4/5 | Shiliang |
| !! | FAIL | addTransactionTest 12 | "tran12\n", "", "12\n", "12.00\n", "1\n", "" | name is set to tran12, value is set to 12.00, with an alert message, category is set to 0, with an alert message, shows "tran12(¥12.00) was added to Unknown" | Category is  set to "tran12". value is set to12. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | / | validation of value has not been created | 23:15 4/5 | Shiliang |
| !!! | FAIL | addTransactionTest 13 | "   \n", "tran13\n", "13.00\n", "", "1\n", "" | name is set to tran13, with an alert message, value is set to 13.00, with an alert message, category is set to 0, shows "tran13(¥13.00) was added to Unknown" | Category is  set to "   ". value is set to13.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. allow blank input | / | blank input has not been banned | 15:11 5/5 | Shiliang |
| !! | FAIL | addTransactionTest 14 | "tran14\n", "", "   \n", "14.00\n", "1\n", "" | name is set to tran14, with an alert message, value is set to 14.00, with an alert message, category is set to 0, shows "tran14(¥14.00) was added to Unknown" | InvocationException | 1. BigDecimal went wrong | / | blank input has not been banned | 15:11 5/5 | Shiliang |
| !! | PASS | addTransactionTest 1' | "tran1\n", "", "1.00\n", "", "1\n", "", "1" | name is set to tran1, value is set to 1.00, category is set to 0, shows "tran1(¥1.00) was added to Unknown" | name is set to tran1, value is set to 1.00, category is set to 0, shows "tran1(¥1.00) was added to "Unknown" prompt message is wrong | 1. Category cant be correctly set up 2. prompt message is different 3. Confirmation message is different | / | 1. No category input is set up 2. The original message does not match new expected one 3. Confirmation message has not been created yet | 23:15 4/5 | Shiliang |
| !! | PASS | addTransactionTest 2' | "\n", "tran2\n", "2.00\n", "", "1\n", "" | name is set to tran2, with an alert message,  value is set to 2.00, category is set to 0, shows "tran2(¥2.00) was added to Unknown" | InvocationException | 1. It does not alert and ask for new input 2. alert an invocation exception | Add a module for category setup, updated the prompt message string, reconstructed confirmation message | 1. No category input is set up 2. The original message does not match new expected one 3. Confirmation message has not been created yet | 23:15 4/5 | Shiliang |
| !! | PASS | addTransactionTest 3' | "tran3\n", "", "\n", "3.00\n", "1\n", "" | name is set to tran3, value is set to 2.00, with an alert message, category is set to 0, shows "tran3(¥3.00) was added to Unknown" | InvocationException | 1. It does not alert the right message and loop 2. alert an invocation exception | Add if statement for exception throw | 1.  no loop was created 2. BigDecimal get a "" | 23:15 4/5 | Shiliang |
|!!! | FAIL | addTransactionTest 4' | "tran4\n", "", "4.00\n", "", "\n", "" | name is set to tran4, value is set to 4.00, category is set to 0, shows "tran4(¥4.00) was added to Unknown" | Category is  set to "tran4". value is set to 4.00. category is  set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop 2. confirmation message is not right | / | the prompt and confirmation message are not reset yet | 23:15 4/5 | Shiliang |
| !! | PASS | addTransactionTest 5' | "tran5\n", "", "5.00\n", "", "6\n", "1\n" (where 6 is not yet created) | name is set to tran5, value is set to 5.00, category is set to 0, with an alert message, shows "tran5(¥5.00) was added to Unknown" | Category is  set to "tran5". value is set to 5.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | Adjust \n to proper places | loop and if are not created | 23:15 4/5 | Shiliang |
| !! | PASS | addTransactionTest 6' | "tran6\n", "", "0.00\n", "6.00\n", "1\n" | name is set to tran6,  value is set to 6.00, with an alert message, category is set to 0, shows "tran6(¥6.00) was added to Unknown" | Category is  set to "tran6". value is set to 0.00. category is set to Unknown, prompt "[Transaction added]" | 1. It does not alert the right message and loop for category | Add if statement for loop | loop and if are not created | 23:15 4/5 | Shiliang |
| !! | PASS | addTransactionTest 7' | "tran7\n", "", "-5.00\n", "7.00\n", "1\n" | name is set to tran7,  value is set to 7.00, with an alert message, category is set to 0, shows "tran7(¥7.00) was added to Unknown" | Category is  set to "tran7". value is set to -5.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | Add if statement for loop | loop and if are not created | 23:15 4/5 | Shiliang |
| !! | PASS | addTransactionTest 8' | "tran8\n", "", "8.00\n", "", "0\n", "1\n" | name is set to tran8, value is set to 8.00, category is set to 0, with an alert message, shows "tran8(¥8.00) was added to Unknown" | Category is  set to "tran8". value is set to 8.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | Add if statement for loop | loop and if are not created | 23:15 4/5 | Shiliang |
| !! | PASS | addTransactionTest 9' | "tran9\n", "", "9.00\n", "", "-1\n", "1\n" | name is set to tran9, value is set to 9.00, category is set to 0, with an alert message, shows "tran9(¥9.00) was added to Unknown" | Category is  set to "tran9". value is set to 9.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | Add if statement for loop                                    | exception throw has not been created | 23:15 4/5 | Shiliang |
| !! | PASS | addTransactionTest 10' | "tttttrrrrraaaaannnnn10101\n", "", "10.00\n", "", "1\n", "" | name is set to tran10, value is set to 10.00, category is set to 0, shows "tttttrrrrraaaaannnnn10101(¥10.00) was added to Unknown" | Category is  set to "tttttrrrrraaaaannnnn10101". value is set to10.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | modified category setup and messages | the prompt and confirmation message are not reset yet. | 23:15 4/5 | Shiliang |
| !! | PASS | addTransactionTest 11' | "tttttrrrrraaaaannnnn111111111111\n", "", "11.00\n", "", "1\n", "" | name is set to tran11, with an alert message,  value is set to 11.00, category is set to 0, shows "tttttrrrrraaaaannnnn111111(¥11.00) was added to Unknown" | Category is  set to "tttttrrrrraaaaannnnn111111111111". value is set to11.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. the length is not right | Add if statement for loop | no truncate exception is catched | 23:15 4/5 | Shiliang |
| !! | PASS | addTransactionTest 12' | "tran12\n", "", "12\n", "12.00\n", "1\n", "" | name is set to tran12, value is set to 12.00, with an alert message, category is set to 0, with an alert message, shows "tran12(¥12.00) was added to Unknown" | Category is  set to "tran12". value is set to12. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. It does not alert the right message and loop for category | Add if statement for loop | validation of value has not been created | 23:15 4/5 | Shiliang |
| !! | PASS | addTransactionTest 13' | "   \n", "tran13\n", "13.00\n", "", "1\n", "" | name is set to tran13, with an alert message, value is set to 13.00, with an alert message, category is set to 0, shows "tran13(¥13.00) was added to Unknown" | Category is  set to "   ". value is set to13.00. category is set to Unknown, prompt "[Transaction added]" prompt message is wrong | 1. allow blank input | add if for " " situation | blank input has not been banned | 15:11 5/5 | Shiliang |
| !! | PASS | addTransactionTest 14' | "tran14\n", "", "   \n", "14.00\n", "1\n", "" | name is set to tran14, with an alert message, value is set to 14.00, with an alert message, category is set to 0, shows "tran14(¥14.00) was added to Unknown" | InvocationException | 1. BigDecimal went wrong | add if for " " situation | blank input has not been banned | 15:11 5/5 | Shiliang |
| !! | PASS | addTransactionTest 4'' | "tran4\n", "4.00\n", "\n" | name is set to tran4, value is set to 4.00, category is set to 0, shows "tran4(¥4.00) was added to Unknown" | / | 1. the third argument went wrong | add if for "" situation | haven't handled \n | 16:31 5/5 | Shiliang |

#### FAILFunction 7: addCategory(Scanner in) - Add Category function

|Importance|Status|Test|Inputs|Expected Outcome|Test Outcome|Problem|Change|Reason|Time|Author|
|----------|------|----|------|----------------|------------|-------|------|------|----|------|
|!!!|FAIL|AddCattegoryTest1|"cat1Name123456789\n", "6.23\n"|prompt of title, prompt of budget and category overview (with the first 15 characters in title)|the incomplete prompt that does not shows the detail of input|the incomplete prompt might let user esaily enter illegal input|/|without specific prompt, users are easily to enter illegal input|15:20 7/5|Jiawei|
| !!! | FAIL | AddCategoryTest2 | "\n","cat1Name\n","6\n","6.00\n" | prompt of title, alert of title, prompt of budget, alert of budget and category overview | the incomplete prompt that does not shows the detail of input |the alert lost and does not repeat unfinished step|/|without specific prompt, users are easily to enter illegal input,| 15:20 7/5 |Jiawei|
| !!! | FAIL | AddCategoryTest3 | "  \n","cat2Name\n","ads\n","6.23\n" | prompt of title, alert of title, prompt of budget, alert of budget and category overview | the incomplete prompt that does not shows the detail of input |the alert lost and does not repeat unfinished step|/| without specific prompt, users are easily to enter illegal input, |15:20 7/5|Jiawei|
| !!! | FAIL | AddCategoryTest4 | "cat2Name\n","cat3Name\n","-7.23\n","34.53\n" | prompt of title, alert of title, prompt of budget, alert of budget and category overview | the incomplete prompt that does not shows the detail of input |the alert lost and does not repeat unfinished step|/| without specific prompt, users are easily to enter illegal input |15:20 7/5|Jiawei|
| !!! | PASS | AddCategoryTest5 | “cat1Name123456789\n”, "6.23\n" | prompt of title, prompt of budget and category overview (with the first 15 characters in title) | prompt of title, prompt of budget and category overview (with the first 15 characters in title) | /                                                            |complete a specific prompt and alert then it will repeat the unfinished step|/|15:20 7/5|Jiawei|
| !!! | PASS | AddCategoryTest6 | "\n","cat1Name\n","6\n","6.00\n" | prompt of title, alert of title, prompt of budget, alert of budget and category overview | prompt of title, alert of title, prompt of budget, alert of budget and category overview |/|complete a specific prompt and alert then it will repeat the unfinished step| / |15:20 7/5|Jiawei|
| !!! | PASS   | AddCategoryTest7 | "  \n","cat2Name\n","ads\n","6.23\n" | prompt of title, alert of title, prompt of budget, alert of budget and category overview | prompt of title, alert of title, prompt of budget, alert of budget and category overview |/|complete a specific prompt and alert then it will repeat the unfinished step| / |15:20 7/5|Jiawei|
| !!! | PASS | AddCategoryTest8 | "cat2Name\n","cat3Name\n","-7.23\n","34.53\n" | prompt of title, alert of title, prompt of budget, alert of budget and category overview | prompt of title, alert of title, prompt of budget, alert of budget and category overview |/|complete a specific prompt and alert then it will repeat the unfinished step| / |15:20 7/5|Jiawei|
