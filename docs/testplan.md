...
| !! | | addTransactionTest 2 | "\n",  "2", "1" | Alert "Transaction name should not be blank!" | | | | | | |
| !! | | addTransactionTest 3 | "tran3", "\n", "1" | Alert "Transaction name should not be blank!", then ask for a new one. For the number, alert "Transaction value should not be blank!", then ask for a new one, the category is set to 0, shows "tran3(¥3) was added to Unknown" | | | | | | |
| !! | | addTransactionTest 4 | "tran4", "4", "\n" | Alert "Transaction name should not be blank!", then ask for a new one. For the number, alert "Transaction value should not be blank!", then ask for a new one, the category is set to 0, shows "tran4(¥4) was added to Unknown" | | | | | | |
