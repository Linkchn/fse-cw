...
|Importance|Status|Test|Inputs|Expected Outcome|Test Outcome|Problem|Change|Reason|Time|Author|
|----------|------|----|------|----------------|------------|-------|------|------|----|------|
| !! | FAIL | AddCategoryTest1 | “cat1Name123456789\n”, "6.23\n" | prompt of title, prompt of budget and category overview are given | "What is the title of the category?\r\n","What is the budget for this category?\r\n", "[Category added]" |the prompts that guide users to input is not detial|/|without specific prompt, users are easily to enter illegal input| 13:49 6/5 |Jiawei|
| !!! | FAIL | AddCategoryTest2 | "\n","cat1Name\n","6\n","6.00\n" | prompt of title, alert of title, prompt of budget, alert of budget, and category overview are given | "What is the title of the category?\r\n" |the alert lost and does not repeat the unfinished step|/|without specific prompt, users are easily to enter illegal input,and  expected exception will not throw| 15:01 6/5 |Jiawei|
| !!! | FAIL | AddCategoryTest3 | "   \n","cat2Name\n","ads\n","6.23\n" | "What is the title of the category?\r\nNOTE: It should not be blank and should be at most 15 characters  or it will get first 15 charaters.\r\n","What is the budget for this category?\r\nNote:It should be a pisitive decimal number with exact two decimal places.\r\n", "[Category added]""1) Unknown(¥0.00) - Est. ¥863.99 (¥863.99 Overspent)\r\n"                "2) Bills(¥120.00) - Est. ¥112.99 (¥7.01 Remaining)\r\n"                "3) Groceries(¥75.00) - Est. ¥31.00 (¥44.00 Remaining)\r\n"                "4) Social(¥100.00) - Est. ¥8.50 (¥91.50 Remaining)\r\n",             "5) cat1Name1234567(¥6.23) - Est. ¥0.00 (¥6.23 Remaining)\r\n" ,"6) cat1Name(¥6.00) - Est. ¥0.00 (¥6.00 Remaining)", "7) cat2Name(¥6.23) - Est. ¥0.00 (¥6.23 Remaining)" | "What is the title of the category?\r\n" |the alert lost and does not repeat the unfinished step|/| without specific prompt, users are easily to enter illegal input,and  expected exception will not throw |15:01 6/5|Jiawei|
| !!! | FAIL | AddCategoryTest4 | " cat2Name  \n","cat3Name\n","-7.23\n","34.52\n" | "What is the title of the category?\r\nNOTE: It should not be blank and should be at most 15 characters  or it will get first 15 charaters.\r\n","What is the budget for this category?\r\nNote:It should be a pisitive decimal number with exact two decimal places.\r\n", "[Category added]""1) Unknown(¥0.00) - Est. ¥863.99 (¥863.99 Overspent)\r\n"                "2) Bills(¥120.00) - Est. ¥112.99 (¥7.01 Remaining)\r\n"                "3) Groceries(¥75.00) - Est. ¥31.00 (¥44.00 Remaining)\r\n"                "4) Social(¥100.00) - Est. ¥8.50 (¥91.50 Remaining)\r\n",             "5) cat1Name1234567(¥6.23) - Est. ¥0.00 (¥6.23 Remaining)\r\n" ,"6) cat1Name(¥6.00) - Est. ¥0.00 (¥6.00 Remaining)", "7) cat2Name(¥6.23) - Est. ¥0.00 (¥6.23 Remaining)", "" 8) cat3Name(¥34.53) - Est. ¥0.00 (¥34.53 Remaining)" | "What is the title of the category?\r\n" |the alert lost and does not repeat the unfinished step|/| without specific prompt, users are easily to enter illegal input,and  expected exception will not throw |15:01 6/5|Jiawei|
